            ...
            init: function( selector, context, rootjQuery ) {
                ...
                if ( typeof selector === "string" ) {
                    ...
                    if ( match && (match[1] || !context) ) {
                        ...
                        var ret = this.constructor( context );
                        // Workaround for Chrome bug - see http://code.google.com/p/chromium/issues/detail?id=125148
                        if ((this instanceof jQuery.fn.init) && !(ret instanceof jQuery.fn.init)) {
                            ret = new jQuery.fn.init(context);
                        }
                        return ret.find( selector );
                    }
